...
public class Data {
	...
	public ArrayList<Test_pojo> invoice_data = new ArrayList<Test_pojo>();

	public  ArrayList<Test_pojo> data_read() {
//		C:\Users\KIIT\Desktop\FLASK\HighRadius
		String path ="C:\\Users\\KIIT\\Desktop\\FLASK\\HighRadius\\1805142.csv";
		String line = "";
		Test_pojo invoice;
...
//		java.sql.Date sqlStartDate = new java.sql.Date(date.getTime())
		...
		try {
			...
			while ((line = bfr.readLine()) != null) {
				...
				invoice.setBill_currency(values[10]);
				...
				try {
					invoice.setBill_id((long)Double.parseDouble(values[17]));
				} catch (Exception e) {
					invoice.setBill_id(null);
				}
