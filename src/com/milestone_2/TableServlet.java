	...
	static final String PASS = "kiit";
		...
		protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			try {
			    ...
			    String selectQuery = "select name_customer,cust_number,bill_id,total_open_amount,due_in_date,clear_date,doc_id,notes from invoice_details limit 100 offset " + val + ";";
				...
				while(rs.next()) {
					...
					invoice.setBill_id(rs.getLong(3));
